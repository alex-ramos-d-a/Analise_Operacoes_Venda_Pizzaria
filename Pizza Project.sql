...
create table tab_geral (id int primary key auto_increment) -- add chave primaria
select  
		order_id,
		pizza_id, 
		quantity,
...
# Modelagem
create table dim_produto (id int primary key auto_increment)  -- Na modelagem não precisa coloca chaves 'Bi reconhe sozinho;
select distinct
		pizza_id,
        pizza_name,
        pizza_size,
...
from tab_geral; -- Problema: E uma pequena granularidae = lentidão;
